...
def setlang(gl):
	if locale.getlocale()[0]=="pl_PL":
		...
		gl.label2.set_label("Za następującą liczbę minut:")
		...
		gl.about.set_comments("Gcounter to aplikacja napisana w języku python z wkorzystaniem biblioteki pyGTK.\nPozwala ona na wyłączenie, ponowne uruchomienie bądź uśpienie komputera o podanym czasie. Korzysta z poleceń: sudo, shutdown, reboot i pm-suspend do standardowych akcji.\n\nCiągle w rozwoju.")
